...
@export (NodePath) var monitored_shape :
	get:
		return monitored_shape # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_monitored_shape
@export (int) var track_control_point :
	get:
		return track_control_point # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_track_control_point
@export (float) var normal_length = 100.0 :
	get:
		return normal_length # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_normal_length
@export (float, -1.0, 1.0) var control_point_offset :
	get:
		return control_point_offset # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_control_point_offset
@export (float, -3.14159, 3.14159) var rotation_offset = 0 :
	get:
		return rotation_offset # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_rotation_offset
@export (bool) var copy_scale = false :
	get:
		return copy_scale # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_copy_scale
