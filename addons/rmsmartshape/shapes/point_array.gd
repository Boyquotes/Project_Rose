...
@export var _points: Dictionary = {} :
	get:
		return _points # TODOConverter40 Non existent get function 
	set(mod_value):
...
@export var _point_order: Array = [] :
	get:
		return _point_order # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of set_point_order
# Key is tuple of point_keys; Value is the CONSTRAINT enum
@export var _constraints = {} :
	get:
		return _constraints # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of set_constraints
# Next key value to generate
@export var _next_key = 0 :
	get:
		return _next_key # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of set_next_key
# Dictionary of specific materials to use for specific tuples of points
# Key is tuple of two point keys
# Value is material
@export (Dictionary) var _material_overrides = null :
	get:
		return _material_overrides # TODOConverter40 Non existent get function 
	set(mod_value):
...
func update_constraints(src: int):
	"""
	Will mutate points based checked constraints
