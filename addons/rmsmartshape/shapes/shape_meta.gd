...
@export (bool) var press_to_update_cached_children = false :
	get:
		return press_to_update_cached_children # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _on_update_children
